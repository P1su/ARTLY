...
import SectionArtistCardList from '../../../../components/SectionAtristCardList/SectionArtistCardList';
  ...
  return (
    <div>
      <section>
        ...
        <SectionCardList items={bookmarkedExhibitions} type='bookmark' />
      </section>
      <section>
        <SectionTitle title='팔로우 중인 작가' />
        <SectionArtistCardList item={followedArtists} />
      </section>
    </div>
  );
}
